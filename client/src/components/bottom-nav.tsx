  ...
  return (
    <nav 
      className={cn(
        ...
        // Transform based on visibility - only apply if isVisible prop is explicitly false
        orientation === "horizontal" && isVisible === false && "translate-y-full",
        orientation === "horizontal" && isVisible === true && "translate-y-0"
      )}>
      <div className={cn(
        // Container styles
        "flex items-center",
