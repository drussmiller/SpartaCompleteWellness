    ...
    <AppLayout title="Comments">
      <div 
        ...
        style={{
          position: 'fixed',
          top: '4rem',
          left: isMobile ? 0 : 'clamp(0px, calc((100vw - 1000px) / 2 + 1.5rem), calc(50vw - 500px + 1.5rem))',
          right: isMobile ? 0 : 'clamp(0px, calc((100vw - 1000px) / 2 + 1.5rem), calc(50vw - 500px + 1.5rem))',
          bottom: 0,
          zIndex: 100
        }}
      >
