...
export const CommentForm = forwardRef<HTMLTextAreaElement, CommentFormProps>(({ 
  ...
  return (
    <div 
      className="flex flex-col gap-1 pb-16 fixed bottom-0 left-0 right-0 bg-background z-50" 
      ref={containerRef}
    ...
    >
      <div className="flex items-end gap-0"> {/* Changed gap from 2 to 1 */}
        <div className="flex-1 relative">
          <div className="absolute bottom-0 w-full pl-8 pr-6">
            <Textarea
              ref={setRefs} 
              value={content}
        ...
        <Button
          ...
          className="self-end b-0 pr-8 pt-1"
        >
