...
export default function NotificationsPage() {
  ...
  if (error) {
    return (
      <AppLayout>
        ...
        <div className="text-center py-8 text-destructive mt-[120px]">
  ...
  return (
    <AppLayout>
      {/* Header */}
      <div className="fixed top-0 left-0 right-0 z-50 bg-background border-b border-border pt-20">
        <div className="max-w-2xl mx-auto p-4">
          <h1 className="text-xl font-bold">Notifications</h1>
        </div>
      </div>

      <main className="pb-24 space-y-4 max-w-2xl mx-auto w-full p-6 text-lg mt-[120px]">
