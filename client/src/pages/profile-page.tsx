  ...
  return (
    ...
    >
      ...
      <header className="fixed top-10 left-0 right-0 z-50 bg-background border-b border-border">
        <div className="p-4 px-4 md:px-8 md:pl-28 flex items-center">
          {onClose && (
            <Button
              variant="ghost"
              size="icon"
      ...
      <main className="flex-1 overflow-y-auto pt-8 md:pt-32 pb-80 px-4 md:px-8 md:pl-28 space-y-6 max-w-4xl mx-auto w-full">
