...
export default function NotificationsPage() {
  ...
  if (isLoading) {
    return (
      <AppLayout>
        {/* Header */}
        <div className="fixed top-0 left-0 right-0 z-50 bg-background border-b border-border pt-12 pb-4">
          <div className="max-w-2xl mx-auto px-4 pt-4">
            <h1 className="text-xl font-bold">Notifications</h1>
          </div>
        </div>
        <div className="flex justify-center items-center h-full mt-[104px]">
  ...
  if (error) {
    return (
      <AppLayout>
        ...
        <div className="text-center py-8 text-destructive mt-[104px]">
  ...
  return (
    <AppLayout>
      ...
      <main className="pb-24 space-y-4 max-w-2xl mx-auto w-full p-6 text-lg mt-[104px]">
