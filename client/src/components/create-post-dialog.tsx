          ...
          <form id="create-post-form" onSubmit={form.handleSubmit((data) => createPostMutation.mutate(data))} className="space-y-4">
            ...
            <div className="flex justify-center mt-6 pb-20">
              <Button
                ...
                variant="default"
                className="w-[calc(100%-2rem)] max-w-full bg-violet-700 hover:bg-violet-800 fixed bottom-16 left-1/2 -translate-x-1/2 sm:w-full sm:relative sm:bottom-auto sm:translate-x-0 sm:left-0"
